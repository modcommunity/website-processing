...
export const hero: SectionCatalog = {
    en: {
        ...
        card1Html: `We're a <span class="special">modding</span> and <span class="special">game development</span> community building one platform for the things that usually live in a dozen different places. Today that's a <a href="/servers" class="${A}">server browser</a>, a <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> and a <a href="https://forum.moddingcommunity.com" class="${A}">forum</a>, with <span class="special">assets</span>, <span class="special">mods</span> and <span class="special">communities</span> rolling out next.`,
    ...
    es: {
        ...
        card1Html: `Somos una comunidad de <span class="special">modding</span> y <span class="special">desarrollo de juegos</span> que construye una sola plataforma para las cosas que suelen estar repartidas en una docena de sitios distintos. Hoy eso es un <a href="/servers" class="${A}">navegador de servidores</a>, un <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> y un <a href="https://forum.moddingcommunity.com" class="${A}">foro</a>, con <span class="special">recursos</span>, <span class="special">mods</span> y <span class="special">comunidades</span> llegando pronto.`,
    ...
    fr: {
        ...
        card1Html: `Nous sommes une communauté de <span class="special">modding</span> et de <span class="special">développement de jeux</span> qui construit une seule plateforme pour les choses habituellement dispersées dans une dizaine d'endroits différents. Aujourd'hui, c'est un <a href="/servers" class="${A}">navigateur de serveurs</a>, un <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> et un <a href="https://forum.moddingcommunity.com" class="${A}">forum</a>, avec des <span class="special">ressources</span>, des <span class="special">mods</span> et des <span class="special">communautés</span> à venir.`,
    ...
    de: {
        ...
        card1Html: `Wir sind eine <span class="special">Modding</span>- und <span class="special">Spieleentwicklungs</span>-Community, die eine einzige Plattform für die Dinge baut, die sonst an einem Dutzend verschiedener Orte liegen. Heute ist das ein <a href="/servers" class="${A}">Server-Browser</a>, ein <a href="https://moddingcommunity.com/blog/" class="${A}">Blog</a> und ein <a href="https://forum.moddingcommunity.com" class="${A}">Forum</a>, mit <span class="special">Ressourcen</span>, <span class="special">Mods</span> und <span class="special">Communitys</span> als Nächstes.`,
    ...
    ru: {
        ...
        card1Title: 'Кто Мы?',
        card1Html: `Мы — сообщество <span class="special">моддинга</span> и <span class="special">разработки игр</span>, создающее единую платформу для того, что обычно разбросано по десятку разных мест. Сегодня это <a href="/servers" class="${A}">браузер серверов</a>, <a href="https://moddingcommunity.com/blog/" class="${A}">блог</a> и <a href="https://forum.moddingcommunity.com" class="${A}">форум</a>, а следом появятся <span class="special">ресурсы</span>, <span class="special">моды</span> и <span class="special">сообщества</span>.`,
    ...
    nl: {
        ...
        card1Html: `We zijn een <span class="special">modding</span>- en <span class="special">game-ontwikkelings</span>community die één platform bouwt voor de dingen die normaal op een dozijn verschillende plekken staan. Vandaag is dat een <a href="/servers" class="${A}">serverbrowser</a>, een <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> en een <a href="https://forum.moddingcommunity.com" class="${A}">forum</a>, met <span class="special">assets</span>, <span class="special">mods</span> en <span class="special">communities</span> die binnenkort volgen.`,
    ...
    ja: {
        ...
        card1Title: '私たちについて',
        card1Html: `私たちは<span class="special">モッディング</span>と<span class="special">ゲーム開発</span>のコミュニティで、普段は十数か所に散らばっているものを一つのプラットフォームにまとめています。今あるのは<a href="/servers" class="${A}">サーバーブラウザ</a>、<a href="https://moddingcommunity.com/blog/" class="${A}">ブログ</a>、<a href="https://forum.moddingcommunity.com" class="${A}">フォーラム</a>で、次に<span class="special">アセット</span>、<span class="special">Mod</span>、<span class="special">コミュニティ</span>が登場します。`,
        card2Title: 'みんなのために',
    ...
    zh: {
        ...
        card1Title: '我们是谁？',
        card1Html: `我们是一个<span class="special">模组制作</span>与<span class="special">游戏开发</span>社区，正在把通常分散在十几个地方的东西整合到一个平台上。如今这包括一个<a href="/servers" class="${A}">服务器浏览器</a>、一个<a href="https://moddingcommunity.com/blog/" class="${A}">博客</a>和一个<a href="https://forum.moddingcommunity.com" class="${A}">论坛</a>，接下来还会推出<span class="special">资源</span>、<span class="special">模组</span>和<span class="special">社区</span>。`,
        card2Title: '为每个人打造',
    ...
    pt: {
        ...
        card1Html: `Somos uma comunidade de <span class="special">modding</span> e <span class="special">desenvolvimento de jogos</span> construindo uma única plataforma para as coisas que normalmente vivem em uma dúzia de lugares diferentes. Hoje isso é um <a href="/servers" class="${A}">navegador de servidores</a>, um <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> e um <a href="https://forum.moddingcommunity.com" class="${A}">fórum</a>, com <span class="special">recursos</span>, <span class="special">mods</span> e <span class="special">comunidades</span> chegando a seguir.`,
