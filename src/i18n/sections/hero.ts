...
export const hero: SectionCatalog = {
    en: {
        ...
        devWarningHtml: `We are currently under <span class="special">heavy development</span>. Community updates are often posted on our <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a>!`,
    },
    es: {
        paraHtml:
        ...
        devWarningHtml: `Actualmente estamos en <span class="special">pleno desarrollo</span>. ¡Las novedades de la comunidad se publican a menudo en nuestro <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a>!`,
    },
    fr: {
        paraHtml:
        ...
        devWarningHtml: `Nous sommes actuellement en <span class="special">plein développement</span>. Les actualités de la communauté sont souvent publiées sur notre <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a> !`,
    },
    de: {
        paraHtml:
        ...
        devWarningHtml: `Wir befinden uns derzeit in <span class="special">intensiver Entwicklung</span>. Community-Neuigkeiten werden oft in unserem <a href="https://moddingcommunity.com/blog/" class="${A}">Blog</a> gepostet!`,
    },
    ru: {
        paraHtml:
        ...
        devWarningHtml: `Сейчас мы находимся в стадии <span class="special">активной разработки</span>. Новости сообщества часто публикуются в нашем <a href="https://moddingcommunity.com/blog/" class="${A}">блоге</a>!`,
    },
    nl: {
        paraHtml:
        ...
        devWarningHtml: `We zijn momenteel volop in <span class="special">ontwikkeling</span>. Community-updates worden vaak geplaatst op ons <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a>!`,
    },
    ja: {
        paraHtml:
        ...
        devWarningHtml: `現在、<span class="special">鋭意開発中</span>です。コミュニティの最新情報は<a href="https://moddingcommunity.com/blog/" class="${A}">ブログ</a>によく投稿されます！`,
    },
    zh: {
        paraHtml:
        ...
        devWarningHtml: `我们目前正在<span class="special">紧张开发中</span>。社区更新经常发布在我们的<a href="https://moddingcommunity.com/blog/" class="${A}">博客</a>上！`,
    },
    pt: {
        paraHtml:
        ...
        devWarningHtml: `Estamos atualmente em <span class="special">intenso desenvolvimento</span>. As novidades da comunidade costumam ser publicadas em nosso <a href="https://moddingcommunity.com/blog/" class="${A}">blog</a>!`,
    },
}
